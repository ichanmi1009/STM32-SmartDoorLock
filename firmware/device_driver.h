...
extern void TIM5_PWM_Init(void);
...
extern void LCD_Send(unsigned char byte, unsigned char rs);
extern void I2C_LCD_Write(unsigned int data);
extern void I2C_LCD_Init(unsigned int freq);